...
const char* password = "20030308174";

//輸入AP端連線帳號密碼  http://192.168.4.1
const char* apssid = "esp32-cam";
const char* appassword = "12345678";         //AP密碼至少要8個字元以上 

String lineNotifyToken = "qC9vXrRBy9sxkrW8Btt39N3I2m7ZBjFLeFsyxA1W3pH";    //Line Notify Token
...
<html>
    ...
    ESP32-CAM IP：<input type="text" id="ip" size="20" value="192.168.">&nbsp;&nbsp;<input type="button" value="Set" onclick="start();">    
        ...
        const modelPath = 'https://teachablemachine.withgoogle.com/models/PkNXhctlA/';
        let currentStream;
